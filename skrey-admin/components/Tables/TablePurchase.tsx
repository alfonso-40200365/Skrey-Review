...
export default function TablePurchase({ stores, products }: TableProductProps) {
            ...
            <div className="md:p-12 md:mx-6">
                ...
                >
                    <Table.Header>
                        ...
                        <Table.Column css={{ paddingLeft: '15px', paddingRight: '15px', textAlign: 'center'}}>ID</Table.Column>
                    ...
                    <Table.Body css={{ textAlign: 'center' }}>
                        {searchedProducts.map((product) => (
                            <Table.Row key={product.id}>
                                ...
                                <Table.Cell>
                                    <div className="flex">
                                        <Button bordered auto color="error" className="ml-2 mr-2">
                                            Delete
                                        </Button>
                                    </div>
                                </Table.Cell>
